...
st.title("Prototipo página de python")

st.title("¡bienvenido a mi página!")

st.subheader("¿De qué trata esta página?")

st.write("En esta pagina se hablara sobre qué es python, para qué sirve, algunos conceptos basicos y por qué es importante que los chicos de tercero sepan sobre python, ¡pero incluso si no sos de tercero esta pagina te podría interesar!")
...
st.subheader("conocimientos básicos en python")

st.write("En el menú de la izquierda o apretando la flechita arriba a la izquierda en el celular, podrán acceder a unos conocimientos basicos de la programacion en python, ademas de algunos video tutoriales si quieren seguir aprendiendo")
