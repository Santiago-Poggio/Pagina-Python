...
st.write("En el menú de la izquierda o apretando la flechita arriba a la izquierda en el celular, podran acceder a unos conocimientos basicos de la programacion en python, ademas de algunos video tutoriales si quieren seguir aprendiendo")
